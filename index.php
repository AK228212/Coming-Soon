...
<body>
        ...
        <div class="content">
            ...
            <p>We are currently working on creating our new website

                We'll be launching soon, Get in touch to be notified</p>
            <a href="../coming soon/form.php" class="btn" id="btn">ASK-Demo</a>
            <!--Start popup-->
           <!-- <div class="popup">
                <div class="popup-content">
                    ...
                    <form action="contact.php" method="post">
                        ...
                        <div class="text-area-content">
                            ...
                            <textarea  id="text-area" cols="12" rows="1" name="message" required></textarea>
                        </div>
                        <button class="submitBtn" id="submitBtn" type="submit">send</button>
                </form>
                </div>
            </div>-->
            <!--End popup-->
